...
function converToLocalTime(serverDate) {
  ...
  return (
    <React.Fragment>
      ...
      <Dialog
        ...
        PaperProps={{
          ...
          data.append('cp_product_price', '');
            ...
            url: process.env.REACT_APP_API_PATH+process.env.REACT_APP_ADD_CAMPAIGN,
            headers: { 
      ...
      {filePath && <img src={filePath2} alt="Uploaded file"  style={{width:80,height:50}}/>}
          </div>
         </Stack>
         ...
         <div style={{flex:0.50}}>
          <label>Campaign Start Date</label>
            ...
            <DateTimePicker disablePast label="Start date time" id="startdate" name="startdate" />
            </DemoContainer>
          ...
          <label>Campaign End Date</label>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DemoContainer components={['DateTimePicker']} >
            <DateTimePicker disablePast label="End date time" id="enddate" name="enddate"/>
            </DemoContainer>
            </LocalizationProvider>
          </div>
         </Stack>
         ...
         <div style={{flex:0.50}}>
          ...
          <textarea id="shortdiscription" name="shortdiscription" rows="4" cols="50" className={styles.textarea}>
        
        </textarea>
          </div>
          <div style={{marginLeft:10,flex:0.50}}>
          <label>Long Discription</label>
          <textarea id="longdiscription" name="longdiscription" rows="4" cols="50" className={styles.textarea}>

    ...
    if (editdetailData !== "") {
      ...
      setFilePath_D(
        process.env.REACT_APP_API_PATH +
          "campaignapi/" +
          editdetailData.result.image_name
      );
      setFilePath_P(
        process.env.REACT_APP_API_PATH +
          "campaignapi/" +
          editdetailData.result.product_image
      );
    }
  }, []);
        ...
        PaperProps={{
          ...
          onSubmit: (event) => {
            ...
            let config = {
              ...
              url:
                process.env.REACT_APP_API_PATH +
                process.env.REACT_APP_UPDATE_CAMPAIGN,
              headers: {
          ...
          <Stack direction={"row"} style={{ flex: 1 }}>
            <div style={{ flex: 0.5 }}>
              ...
              <TextField
                ...
                variant="standard"
                onChange={(e) =>
                  setDatashow({ ...datashow, cp_name: e.target.value })
                }
              />
            </div>
            <div style={{ marginLeft: 10, flex: 0.5 }}>
              ...
              <TextField
                ...
                variant="standard"
                onChange={(e) =>
                  setDatashow({ ...datashow, cp_name_ar: e.target.value })
                }
              />
            </div>
          </Stack>
          ...
          <Stack direction={"row"} style={{ flex: 1 }}>
            <div style={{ flex: 0.5 }}>
              ...
              <TextField
                ...
                variant="standard"
                onChange={(e) =>
                  setDatashow({ ...datashow, product_name: e.target.value })
                }
              />
            </div>
            <div style={{ marginLeft: 10, flex: 0.5 }}>
          ...
          <Stack direction={"row"} style={{ flex: 1 }}>
            <div style={{ flex: 0.5 }}>
              ...
              <TextField
                ...
                variant="standard"
                onChange={(e) =>
                  setDatashow({ ...datashow, dealprice: e.target.value })
                }
              />
            </div>
            <div style={{ marginLeft: 10, flex: 0.5 }}>
              ...
              <TextField
                ...
                variant="standard"
                onChange={(e) =>
                  setDatashow({ ...datashow, joindeal_count: e.target.value })
                }
              />
            </div>
          </Stack>
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DemoContainer components={["DateTimePicker"]}>
                  <DateTimePicker
                    ...
                    id="startdate"
                    name="startdate"
                    value={dayjs(datashow.deal_startdate)}
                    onChange={(e) =>
                      setDatashow({
                        ...datashow,
                        deal_startdate: e.target.value,
                      })
                    }
                  />
                </DemoContainer>
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DemoContainer components={["DateTimePicker"]}>
                  <DateTimePicker
                    ...
                    onChange={(e) =>
                      setDatashow({ ...datashow, deal_enddate: e.target.value })
                    }
                  />
                </DemoContainer>
              </LocalizationProvider>
          ...
          <Stack direction={"row"} style={{ flex: 1 }}>
            <div style={{ flex: 0.5 }}>
              ...
              <textarea
                ...
                value={datashow.shortdiscription}
                onChange={(e) =>
                  setDatashow({ ...datashow, shortdiscription: e.target.value })
                }
              ></textarea>
            </div>
            <div style={{ marginLeft: 10, flex: 0.5 }}>
              ...
              <textarea
                ...
                cols="50"
                className={styles.textarea}
                value={datashow.longdiscription}
                onChange={(e) =>
                  setDatashow({ ...datashow, longdiscription: e.target.value })
                }
              ></textarea>
            </div>
          </Stack>
